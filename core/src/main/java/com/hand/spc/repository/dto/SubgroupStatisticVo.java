...
public class SubgroupStatisticVo {
    ...
    private List<SampleSubgroupRelationR> sampleSubgroupRelationList;//
    ...
    public List<SampleSubgroupRelationR> getSampleSubgroupRelationList() {
        return sampleSubgroupRelationList;
    }

    public void setSampleSubgroupRelationList(List<SampleSubgroupRelationR> sampleSubgroupRelationList) {
