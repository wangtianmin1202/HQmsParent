package com.hand.spc.pspc_sample_subgroup_rel.dto;
...
public class SampleSubgroupRel extends BaseDTO {

     public static final String FIELD_SAMPLE_SUBGROUP_RELATION_ID = "sampleSubgroupRelationId";
    ...
    @Id
    @GeneratedValue
     private Float sampleSubgroupRelationId;
     ...
     public void setSampleSubgroupRelationId(Float sampleSubgroupRelationId){
         this.sampleSubgroupRelationId = sampleSubgroupRelationId;
     }

     public Float getSampleSubgroupRelationId(){
