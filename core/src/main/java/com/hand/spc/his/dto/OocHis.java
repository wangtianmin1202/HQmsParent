...
public class OocHis extends BaseDTO {

     public static final String FIELD_OOC_HIS_ID = "oocHisId";
    ...
    public void setOocHisId(Float oocHisId){
         this.oocHisId = oocHisId;
     }

     public Float getOocHisId(){
         return oocHisId;
     }
