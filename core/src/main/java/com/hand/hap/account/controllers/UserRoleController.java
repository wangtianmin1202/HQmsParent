...
public class UserRoleController extends BaseController {
     ...
     * @throws BaseException
     */
    @PostMapping(value = "/sys/userrole/queryRoleByUser")
    public ResponseData queryRoleByUser(HttpServletRequest request, UserRole userRole) throws BaseException {        
        return new ResponseData(userRoleService.queryRoleByUser(userRole));
    }
