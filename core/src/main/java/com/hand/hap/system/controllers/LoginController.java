...
public class LoginController extends BaseController implements InitializingBean {
	...
	public ModelAndView changeRole(HttpServletRequest request, HttpServletResponse response, Long roleId)
	...
	public ModelAndView resetPassword(HttpServletRequest request, String newPwd, String newPwdAgain)
		...
		try {
			...
			if (e instanceof IBaseException) {
				...
				view.addObject("update_password_title",
						updatePasswordTitle(StringUtils.isEmpty(reason) ? "RESET" : reason, locale));
