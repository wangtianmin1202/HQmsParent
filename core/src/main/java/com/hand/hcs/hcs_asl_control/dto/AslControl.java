package com.hand.hcs.hcs_asl_control.dto;
...
@Table(name = "HCS_ASL_CONTROL")
public class AslControl {

	@JsonIgnore
    @Column(updatable = false)
    @Condition(exclude = true)
	private Date creationDated;
	...
	private Float underdeliveryToleranceLimit;

	private Float overdeliveryToleranceLimit;

	private Float purchaseLeadTime;
	
	public Float getUnderdeliveryToleranceLimit() {
		return underdeliveryToleranceLimit;
	}

	public void setUnderdeliveryToleranceLimit(Float underdeliveryToleranceLimit) {
		this.underdeliveryToleranceLimit = underdeliveryToleranceLimit;
	}

	public Float getOverdeliveryToleranceLimit() {
		return overdeliveryToleranceLimit;
	}

	public void setOverdeliveryToleranceLimit(Float overdeliveryToleranceLimit) {
		this.overdeliveryToleranceLimit = overdeliveryToleranceLimit;
	}
	...
	public void setCreationDated(Date creationDated) {
