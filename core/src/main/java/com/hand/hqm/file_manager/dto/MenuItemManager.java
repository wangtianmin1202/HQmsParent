...
public class MenuItemManager implements Comparable<MenuItemManager>, Serializable {
    private static final long serialVersionUID = -1412546289282861225L;
    private List<MenuItemManager> children;
    ...
    @JsonIgnore
    private MenuItemManager parent;
    private long score;
	...
	@Override
    public int compareTo(MenuItemManager o) {
	...
	public List<MenuItemManager> getChildren() {
		return children;
	}

	public void setChildren(List<MenuItemManager> children) {
