...
public class HqmLevelMenuItem implements Comparable<HqmLevelMenuItem>, Serializable {
    private static final long serialVersionUID = -1412546289282861225L;
    private List<HqmLevelMenuItem> children;
    ...
    @JsonIgnore
    private HqmLevelMenuItem parent;
    private long score;
   ...
   @Length(max = 200)
	...
	@Override
    public int compareTo(HqmLevelMenuItem o) {
	...
	public List<HqmLevelMenuItem> getChildren() {
		return children;
	}

	public void setChildren(List<HqmLevelMenuItem> children) {
