package com.hand.hqm.hqm_sop_pqc_control_l.dto;
...
@Table(name = "HQM_SOP_PQC_CONTROL_L")
public class SopPqcControlL extends BaseDTO {
     ...
     public static final String FIELD_WORKSTATION_CODE = "workstationCode";
     public static final String FIELD_WORKSTATION_DES = "workstationDes";
	...
	public Float getProdLine() {
		return prodLine;
	}

	public void setProdLine(Float prodLine) {
