...
public class HqmdbMenuItem implements Comparable<HqmdbMenuItem>, Serializable {
    private static final long serialVersionUID = -1412546289282861225L;
    private List<HqmdbMenuItem> children;
	...
	@Override
    public int compareTo(HqmdbMenuItem o) {
	...
	public List<HqmdbMenuItem> getChildren() {
		return children;
	}

	public void setChildren(List<HqmdbMenuItem> children) {
